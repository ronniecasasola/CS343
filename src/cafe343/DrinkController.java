...
import static cafe343.AppetizerController.listAppetizerObject;
import java.io.File;
...
public class DrinkController implements Initializable {
    ...
    */
    private void storeMenuImages(){
        ...
        for(int i = 0; i < menuObjectList.size(); i++){
            listOfImages.add(new Image("drinkImages/"+Integer.toString(i+1)+".png"));
        }
    }   
    ...
    */
    ...
    public static void listDrinkObject(){
        ...
        File file = new File("src/data/Drinks.txt");
        try {
